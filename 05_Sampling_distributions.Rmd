...
One of the most common sampling distributions is the _t_ distribution.  If we knew the standard deviation for a variable in a whole population, we can create what is called the _z_ distribution.  It is bell-shaped with a mean of $0$.
...
The _t_ distribution appears very much bell-shaped.  For larger sample sizes, this distribution actually approximates the normal distribution.

In the graph below we see a dark line representing a DOF value of $30$.  Considering the mean at $0$, we see successive curves for DOF values of $1,2,3,4,10$ (from the bottom up).
